...
<script>
  ...
  function parseRoute() {
    ...
    if (!isAuthenticated && !['login', 'register', 'public'].includes(hash)) {
      return 'login';
    }
    ...
    {:else}
      ...
      {#if currentPage === 'login'}
        <div class="page-container">
          ...
          <div class="placeholder-form">
            ...
            <button on:click={() => handleLoginSuccess({ username: 'demo' })}>
              Demo Login
            </button>
            <p>
              Don't have an account? 
              <button class="link-button" on:click={() => handleNavigation('register')}>
                Register here
              </button>
            </p>
          </div>
      ...
      {:else if currentPage === 'register'}
        <div class="page-container">
          ...
          <div class="placeholder-form">
            ...
            <button on:click={() => handleRegisterSuccess({ username: 'demo' })}>
              Demo Register
            </button>
            <p>
              Already have an account? 
              <button class="link-button" on:click={() => handleNavigation('login')}>
                Login here
              </button>
            </p>
          </div>
      ...
      {:else}
        <div class="page-container">
          ...
          <button on:click={() => handleNavigation(isAuthenticated ? 'my-books' : 'login')}>
            Go Home
          </button>
        </div>
      {/if}
